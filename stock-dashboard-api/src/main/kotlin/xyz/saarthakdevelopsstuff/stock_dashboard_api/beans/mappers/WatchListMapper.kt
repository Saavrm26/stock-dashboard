...
interface WatchListMapper {
    ...
    fun toCreateWatchListServiceModel(request: WatchListRequest): CreateWatchList

    fun toCreateWatchListTickerServiceModel(ticker: WatchListRequestTickers): CreateWatchListTicker
    ...
    fun toWatchListAggregatedResponse(watchList: WatchListAggregate): WatchListAggregatedResponse
